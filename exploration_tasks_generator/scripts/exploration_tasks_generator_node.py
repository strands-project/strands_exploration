...
class TaskGenerator(object):
    ...
    def __init__(self):
        ...
        self.timer=rospy.Timer(rospy.Duration(60*2), self.add_tasks_to_schedule)
        self.add_task_srv=rospy.ServiceProxy('/task_executor/add_task', AddTask)
        
    
    def add_tasks_to_schedule(self, timer_event):
        task_list=generator.services_manager.generate_tasks(rospy.get_rostime(),rospy.get_rostime()+rospy.Duration(20*60))
